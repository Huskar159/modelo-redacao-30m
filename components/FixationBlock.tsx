...
export const FixationBlock: React.FC<Props> = ({ topic, description }) => {
  return (
    <section className="h-[19%] mt-auto border-2 border-gray-100 rounded-xl p-3 bg-gray-50/30 flex flex-col">
      ...
      {/* Lined Paper Effect Area - Reduced to 2 lines (4rem) to ensure it fits in print without cutoff */}
      <textarea 
        className="w-full flex-1 resize-none bg-white border border-gray-200 rounded-md lined-paper px-3 text-gray-800 text-sm outline-none focus:border-primary-400 transition-colors min-h-[4rem]"
